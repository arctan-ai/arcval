...
class _Tests:
    ...
    async def _run_single_model(
        ...
        from arcval.judges import write_evaluator_config
        from arcval.utils import configure_print_logger, log_and_print
    ...
    async def run_inference(
        ...
        """
        from arcval.llm.run_tests import run_inference as _run_inference
...
class _Simulations:
    ...
    async def run_simulation(
        ...
        """
        from arcval.llm.run_simulation import run_simulation as _run_simulation
