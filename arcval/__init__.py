"""
arcval - A package for voice agent evaluation and benchmarking.
...
# broken/incompatible provider dependency makes `import arcval` fail
# entirely. Use PEP 562 module-level __getattr__ so a submodule is only
# imported when it is actually accessed (e.g. `arcval.stt`), while keeping
