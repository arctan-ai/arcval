...
| Command                 | Description                                       |
| ----------------------- | ------------------------------------------------- |
| `arcval stt`         | Interactive STT evaluation — benchmark providers  |
| `arcval tts`         | Interactive TTS evaluation — benchmark providers  |
| `arcval llm`         | Interactive LLM evaluation — test agent responses |
