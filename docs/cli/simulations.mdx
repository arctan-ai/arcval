...
<AccordionGroup>
  ...
  <Accordion title="Agent connection example">
    See the [full file on GitHub](https://github.com/ARTPARK-SAHAI-ORG/arcval/tree/main/examples/agent/simulation/sample_text_agent_connection.json).
