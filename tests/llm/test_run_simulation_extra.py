"""Extra coverage for arcval/llm/run_simulation.py — helpers, eval-only path, agent simulation."""
...
class TestBuildEvaluationResult(unittest.TestCase):
    def test_binary(self):
        from arcval.llm.run_simulation import _build_evaluation_result
...
class TestSaveTranscript(unittest.TestCase):
    def test_no_output_dir_returns(self):
        from arcval.llm.run_simulation import _save_transcript
...
class TestRunEvalOnlySimulations(unittest.IsolatedAsyncioTestCase):
    async def test_run_eval_only_full(self):
        from arcval.llm.run_simulation import run_eval_only_simulations
...
class TestAggregateAndWrite(unittest.TestCase):
    def test_aggregates(self):
        from arcval.llm.run_simulation import _aggregate_and_write_simulation_results
...
class TestResolveSimulationParallel(unittest.TestCase):
    ...
    def test_default_when_neither_set(self):
        from arcval.llm.run_simulation import (
